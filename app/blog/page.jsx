...
const page = () => {
  return (
    <div className="">
      ...
      <div className="flex justify-between flex-wrap lg:p-24 md:px-16 px-8 py-12">
        {[blogPostCard.map((post) => (
            ...
            <div className="p-4">
                ...
                <p className="font text-sm sm:ext-md h-[100px]">
                ...
                <button className="bg-black text-white py-1 px-5 mt-2  rounded-lg font text-base">Read</button>
            </div>
            </div>
        ))]
        }
